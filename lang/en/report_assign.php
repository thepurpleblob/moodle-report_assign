...
$string['coursefields_desc'] = 'Include fields from the course record';
...
$string['fieldoptions_desc'] = 'Modify how reports are generated';
$string['grade'] = 'Grade';
...
$string['latenessincext'] = 'Lateness (including extensions)';
$string['name'] = 'Name';
...
$string['splitusername'] = 'Split user\'s name into separate fields';
$string['status'] = 'Status';
$string['submissionfields'] = 'Submission fields';
$string['submissionfields_desc'] = 'Include these submission fields in the report';
$string['submissionplugins'] = 'Submission plugins';
$string['submissionplugins_desc'] = 'Include information from these submission plugins in the report. (Plagiarism plugins are included separately)';
